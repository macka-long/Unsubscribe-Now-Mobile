    ...
    return (
        <IonPage>
            ...
            >
                ...
                <h3 style={{ fontSize: '1.2rem', fontWeight: 'bold', marginBottom: '0.5rem' }}>ログイン</h3>
                ...
                {/* {!result && (
                    <IonText color="danger" style={{ marginBottom: '1rem' }}>
                        {errMsg}
                    </IonText>
                )} */}

                <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                    <IonButton onClick={handleLogin} style={{ backgroundColor: '#f9a825', color: 'black' }}>
                        ログイン
                    </IonButton>
                </div>
