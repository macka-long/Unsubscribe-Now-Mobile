    ...
    return (
        <IonPage>
            <IonContent className="ion-padding" fullscreen>
                <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', marginBottom: '1rem' }}>{currentStage?currentStage.title:'サイト名'}</h2>
                ...
                <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
                    <IonText color="primary" onClick={() => history.push('/terms', {
                        ratePerSecond: currentStage?.ratePerSecond,
                        siteName: currentStage?.title,
                        isStarted: false
